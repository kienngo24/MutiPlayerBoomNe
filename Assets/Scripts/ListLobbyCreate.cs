...
public class ListLobbyCreate : MonoBehaviour
{
    ...
    private void Start() {
        txtGameMode.text = gameMode.ToString();
        ...
        btnCreate.ClickFunc = () =>
        {
            ...
            LobbyManager.Instance.CreateLobby("Lobby Room",maxPlayers,isPrivate, gameMode);
        };
